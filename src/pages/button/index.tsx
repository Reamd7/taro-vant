  ...
  return (
    <View>
      <DemoBlock title="按钮类型" padding>
        <View className="row">
          <VanButton className="demo-margin-right" plain>默认按钮</VanButton>
      ...
      <DemoBlock title="加载状态" padding>
        ...
        />
        <VanButton loading type="info" loading-text="加载中..." />
      </DemoBlock>
      ...
      <DemoBlock title="块级元素" padding>
        <VanButton type="primary" className="demo-margin-bottom">
          普通按钮
        </VanButton>
